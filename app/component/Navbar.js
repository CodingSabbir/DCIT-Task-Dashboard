      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-start">
          ...
          <a href="#" className="text-xl font-bold flex items-center lg:ml-2.5">
            <Image src="/img/logo-DHSNsfh_.png" className="h-6 w-6 mr-2" alt="Windster Logo" width={400} height={400}/>
            <span className="self-center whitespace-nowrap">DCIT</span>
          </a>
        ...
        <div className="flex items-center">
          ...
          <div className="hidden lg:flex items-center">
            <span className="text-base font-normal text-gray-500 mr-5">Notification  </span>
            <div className="-mb-1">
